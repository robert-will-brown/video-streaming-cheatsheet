...
Audio \textit{Codec} for online video and live streaming.

\smallskip
\textbf{ABR (Adaptive Bitrate Streaming)}
Choosing an appropriate \textit{Encode} quality dynamically by analysing the available bandwidth and CPU.
...
Monetisation Model - Buying or renting a piece of content. In the case of live events, TVOD can also be known as Pay-Per-View (PPV).
