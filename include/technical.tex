...
\smallskip
\textbf{H.26[1|2|3|4|5]}
Standards-based Codec.\\
H.262 more commonly called \textit{MPEG-2}.\\
H.264 also known as \textit{AVC} or  \textit{MPEG-4 Part 10}.
H.265 also known as \textit{HEVC} or \textit{MPEG-H}. 25\% to 50\% better compression at the same level of video quality, or substantially improved video quality at the same bit rate. It supports resolutions up to 8192×4320, including 8K \textit{UHD}.
